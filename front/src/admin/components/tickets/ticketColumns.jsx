...
const getPriorityBadge = (priority) => {
  const config = {
    low: { label: "Low", className: "bg-blue-100 text-blue-700 hover:bg-blue-200" },
    medium: { label: "Medium", className: "bg-yellow-100 text-yellow-700 hover:bg-yellow-200" },
    high: { label: "High", className: "bg-orange-100 text-orange-700 hover:bg-orange-200" },
    urgent: { label: "Urgent", className: "bg-red-600 text-white hover:bg-red-700" },
  };
...
const getStatusBadge = (status) => {
  const config = {
    open: { label: "Open", className: "bg-blue-600 text-white hover:bg-blue-700" },
    in_progress: { label: "In Progress", className: "bg-purple-600 text-white hover:bg-purple-700" },
