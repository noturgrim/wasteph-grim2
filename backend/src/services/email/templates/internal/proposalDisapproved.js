...
/**
 * Generate proposal disapproved email HTML (admin rejection)
 * Mirrors proposalResponse.js structure for consistency
 * @param {Object} data - Notification data
 * @returns {string} HTML content
 */
export const generateProposalDisapprovedEmailHTML = (data) => {
    ...
    <tr>
      <td>
        <div class="container">
          ...
          <!-- Header -->
          <div class="header">
            <span class="status-badge">Rejection Notice</span>
            <h1>Proposal Disapproved</h1>
            <p class="subtitle">Admin has rejected your proposal</p>
          </div>
          ...
          <div class="content">
            <table class="data-grid" cellpadding="0" cellspacing="0">
              ...
              <tr class="data-row">
                ...
                <td class="value" style="color: #ef4444; font-weight: 700;">DISAPPROVED</td>
              </tr>
              ${rejectionReason ? `<tr class="data-row"><td class="label">Reason</td><td class="value">${rejectionReason}</td></tr>` : ""}
              <tr class="data-row">
            ...
            <div class="highlight-box">
              <p style="font-size: 14px; color: #374151; margin: 0; line-height: 1.6;">
                <strong style="color: #dc2626;">Admin has disapproved this proposal.</strong> Review the feedback above and revise your proposal before resubmitting for approval.
              </p>
            </div>
            ...
            <div class="next-steps">
              <p style="font-size: 13px; color: #374151; margin: 0; line-height: 1.5;">
                <strong style="color: #dc2626;">Suggested Actions:</strong><br>
                • Review the rejection reason and address admin feedback<br>
                • Update proposal content or pricing as needed<br>
